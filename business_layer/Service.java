 ...
 * @author	Kim Desorcie
 * @version 8
 * Business layer Services record
 * Handles viewing, editing and inserting records, and enforces user permissions.
*/

public class Service extends data_layer.Service implements Record {
	...
	*/
	...
	/**
	 * Constructor
	 * @param baseRecord data_layer.Service data layer object to base this object on
	*/
	public Service(data_layer.Service baseRecord) {
	...
	*/
	public Service(String userID, String recordID) {
	...
	*/
	public Service(ArrayList<String> values) {
		super(values);
	} 
