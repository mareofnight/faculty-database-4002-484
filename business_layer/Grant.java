 ...
 * @version 8
 * Business layer Grants record
 * Handles viewing, editing and inserting records, and enforces user permissions.
*/

public class Grant extends data_layer.Grant implements Record {
	...
	*/
	...
	/**
	 * Constructor
	 * @param baseRecord data_layer.Grant data layer object to base this object on
	*/
	public Grant(data_layer.Grant baseRecord) {
	...
	*/
	public Grant(String userID, String recordID) {
	...
	*/
	public Grant(ArrayList<String> values) {
		super(values);
	} 
