 ...
 * @version 8
 * Business layer Pubs record
 * Handles viewing, editing and inserting records, and enforces Pub permissions.
*/

public class Pub extends data_layer.Pub implements Record {
	...
	*/
	...
	/**
	 * Constructor
	 * @param baseRecord data_layer.Pub data layer object to base this object on
	*/
	public Pub(data_layer.Pub baseRecord) {
	...
	*/
	public Pub(String userID, String recordID) {
	...
	*/
	public Pub(ArrayList<String> values) {
		super(values);
	} 
