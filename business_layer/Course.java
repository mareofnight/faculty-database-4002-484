 ...
 * @version 8
 * Business layer Courses record
 * Handles viewing, editing and inserting records, and enforces user permissions.
*/

public class Course extends data_layer.Course implements Record {
	...
	*/
	...
	/**
	 * Constructor
	 * @param baseRecord data_layer.Course data layer object to base this object on
	*/
	public Course(data_layer.Course baseRecord) {
	...
	*/
	public Course(String userID, String recordID) {
	...
	*/
	public Course(ArrayList<String> values) {
		super(values);
	} 
